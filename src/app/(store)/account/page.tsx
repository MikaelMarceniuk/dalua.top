...
export default function AccountPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-[1200px] px-0 py-0 md:px-6 md:py-10">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeNav === id
                      ...
                      : 'border-l-2 border-transparent text-muted-foreground hover:bg-secondary/20 hover:text-foreground'
                  )}
                >
                ...
                <div className="border border-border p-6">
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1">
                      <span className="mb-2 inline-block border border-border px-2 py-0.5 text-[10px] tracking-[0.1em] text-muted-foreground uppercase">
                        Replenish
                      </span>
                      ...
                      <Link
                        ...
                        className="inline-flex items-center rounded-sm bg-[#8daa91] px-5 py-2.5 text-xs tracking-[0.1em] text-white uppercase transition-colors hover:bg-[#7d9a81]"
                      >
                        Buy Again — $85
                      </Link>
                    </div>
