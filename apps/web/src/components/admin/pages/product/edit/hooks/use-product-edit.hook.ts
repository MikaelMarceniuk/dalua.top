...
import { useUpdateProduct } from '@/components/admin/pages/product/hooks/use-update-product.hook'
import { useCreateProductImage } from '@/components/admin/pages/product/hooks/use-create-product-image.hook'
import { useUpdateProductImage } from '@/components/admin/pages/product/hooks/use-update-product-image.hook'
